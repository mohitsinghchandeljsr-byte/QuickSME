...
export default function EInvoice() {
  ...
  const handleDownloadPDF = async () => {
    // Find the e-invoice details card
    const element = document.querySelector('h2:has-text("e-Invoice Details")')?.closest('div[class*="p-8"]') as HTMLElement;
    if (!element) {
      console.error('Could not find e-invoice details element');
      return;
    }
              ...
              <Card className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    <Button onClick={handleDownloadPDF} className="flex-1" data-testid="button-download-pdf">
